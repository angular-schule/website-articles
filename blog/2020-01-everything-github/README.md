...
- [5. Automating the Deployment with GitHub Actions](#5-automating-the-deployment-with-github-actions)
  ...
  - [5.2 Automate a public repo (via GH_TOKEN)](#52-automate-a-public-repo-via-gh_token-)
  ...
  - [5.3 Automate a private repo (via GITHUB_TOKEN)](#53-automate-a-private-repo-via-github_token-)
